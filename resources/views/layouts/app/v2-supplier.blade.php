...
{{--                    dashboard--}}
                ...
                <div class="dropdown pb-4">
                    ...
                    <ul class="dropdown-menu dropdown-menu-dark text-small shadow">
                        ...
                        <li><a class="dropdown-item" href="{{ route('supplier.setting') }}">Settings</a></li>
                        <li><a class="dropdown-item" href="{{ route('supplier.profile') }}">Profile</a></li>
                        <li>
        ...
        <div class="col py-3 bg-dark text-light">
            <span class="text-secondary">Supplier > Dashboard > @yield('page')</span>
