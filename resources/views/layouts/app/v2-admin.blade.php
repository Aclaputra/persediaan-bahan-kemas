...
{{--                    dashboard--}}
                    <li>
                        <a href="{{ route('admin.gudang.dashboard') }}" class="nav-link px-0 align-middle">
                    ...
                    <li>
                        ...
                        <ul class="collapse nav flex-column ms-1" id="submenu4" data-bs-parent="#menu">
                            <li class="w-100">
                                <a href="{{ route('admin.gudang.masuk.index') }}" class="nav-link px-0 text-secondary"> <span class="d-none d-sm-inline">Barang Masuk</span> </a>
                            </li>
                            <li>
                                <a href="{{ route('admin.gudang.keluar.index') }}" class="nav-link px-0 text-secondary"> <span class="d-none d-sm-inline">Barang Keluar</span> </a>
                            </li>
                        </ul>
                    </li>
                    {{-- Data Suppliers --}}
                    <li>
                        <a href="{{ route('admin.gudang.supplier.index') }}" class="nav-link px-0 align-middle">
                    ...
                    {{-- Data Customers--}}
                    <li>
                        <a href="{{ route('admin.gudang.customer.index') }}" class="nav-link px-0 align-middle">
